...
export const scheduledVideosTable = pgTable("scheduled_videos", {
  ...
  useOriginalTitle: boolean("use_original_title").notNull().default(false),
  titleManuallyEdited: boolean("title_manually_edited").notNull().default(false),
  captionManuallyEdited: boolean("caption_manually_edited").notNull().default(false),
...
export const ScheduledVideoSchema = z.object({
  ...
  useOriginalTitle: z.boolean().optional(),
  titleManuallyEdited: z.boolean().optional(),
  captionManuallyEdited: z.boolean().optional(),
