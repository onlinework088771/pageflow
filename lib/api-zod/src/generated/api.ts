 ...
 */
export const ListYoutubeAccountsResponseItem = zod.object({
  id: zod.string(),
  googleId: zod.string(),
  name: zod.string(),
  email: zod.string().optional(),
...
export const ListYoutubeAccountsResponse = zod.array(
  ListYoutubeAccountsResponseItem,
);

/**
 * @summary Disconnect a Google/YouTube account
 */
export const DeleteYoutubeAccountParams = zod.object({
  accountId: zod.coerce.string(),
});
 ...
 */
export const SyncYoutubeAccountChannelsParams = zod.object({
  accountId: zod.coerce.string(),
});

export const SyncYoutubeAccountChannelsResponse = zod.object({
  synced: zod.number(),
});
 ...
 */
export const ListYoutubeChannelsResponseItem = zod.object({
  id: zod.string(),
  accountId: zod.string(),
  ...
  automationEnabled: zod.boolean(),
  sourceType: zod.enum(["instagram", "tiktok", "youtube"]).optional(),
  sourceIdentity: zod.string().optional(),
  postsPerDay: zod.number(),
  scheduleLogic: zod.enum(["fixed", "random"]),
  timezone: zod.string(),
  ...
  status: zod.enum(["active", "paused", "error"]),
  lastPostedAt: zod.string().optional(),
  lastPostedVideoId: zod.string().optional(),
  totalPosted: zod.number(),
  totalFailed: zod.number(),
  createdAt: zod.string(),
});
export const ListYoutubeChannelsResponse = zod.array(
  ListYoutubeChannelsResponseItem,
);

/**
 * @summary Add a YouTube channel to management
 */
export const CreateYoutubeChannelBody = zod.object({
  accountId: zod.string(),
  channelId: zod.string(),
  name: zod.string(),
  description: zod.string().optional(),
 ...
 */
export const GetYoutubeChannelParams = zod.object({
 ...
 */
export const UpdateYoutubeChannelParams = zod.object({
  channelId: zod.coerce.string(),
});

export const UpdateYoutubeChannelBody = zod.object({
  automationEnabled: zod.boolean().optional(),
  status: zod.enum(["active", "paused"]).optional(),
});

export const UpdateYoutubeChannelResponse = zod.object({
  id: zod.string(),
  accountId: zod.string(),
  channelId: zod.string(),
  name: zod.string(),
 ...
 */
export const DeleteYoutubeChannelParams = zod.object({
  channelId: zod.coerce.string(),
});
 ...
 */
export const UpdateYoutubeChannelAutomationParams = zod.object({
  channelId: zod.coerce.string(),
});

export const UpdateYoutubeChannelAutomationBody = zod.object({
  postsPerDay: zod.number().optional(),
  scheduleLogic: zod.enum(["fixed", "random"]).optional(),
  timezone: zod.string().optional(),
  timeSlots: zod.array(zod.string()).optional(),
...
export const UpdateYoutubeChannelAutomationResponse = zod.object({
  id: zod.string(),
  accountId: zod.string(),
  channelId: zod.string(),
  name: zod.string(),
 ...
 */
export const UpdateYoutubeChannelSourceParams = zod.object({
  channelId: zod.coerce.string(),
});

export const UpdateYoutubeChannelSourceBody = zod.object({
  sourceType: zod.enum(["instagram", "tiktok", "youtube", "facebook"]),
  sourceIdentity: zod.string(),
});

export const UpdateYoutubeChannelSourceResponse = zod.object({
  id: zod.string(),
  accountId: zod.string(),
  channelId: zod.string(),
  name: zod.string(),
